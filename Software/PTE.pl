% Probabilistic Trace Expresions code, in SWI-Prolog %
...
% MATCHES FOR CHECKING THE PROBABILIZE AND TEST_PROB ALGORITHMS
...
/* Viviana, deleted for running probability tests */
/* match(ET, (ET, _)) :- !.
match(ET, ET). */
...
% TESTS FOR CHECKING THE PROBABILIZE AND TEST_PROB ALGORITHMS

check1 :-
T = ((a:epsilon) |  epsilon),
probabilize(T, ProbabilizedT),
write('\nResult of probabilize: \n'),
write(ProbabilizedT),
nl,
test_prob(ProbabilizedT, CTProbT),
write('\nResult of test_prob: \n'),
write(CTProbT),
nl.

check2 :-
T = ((a:epsilon) |  (b:epsilon)),
probabilize(T, ProbabilizedT),
write('\nResult of probabilize: \n'),
write(ProbabilizedT),
nl,
...
check3 :-
T = ((a:b:c:d:epsilon) |  (e:f:g:h:epsilon)),
probabilize(T, ProbabilizedT),
write('\nResult of probabilize: \n'),
write(ProbabilizedT),
nl,
...
create_output_file(ID, T, MaxLength, NTests, MinProbNoise, MaxProbNoise, MinProbMsgNoise, MaxProbMsgNoise, Partition) :-
  ...
  findall(_,
    (
      ...
      test_trace_expression(T, Traces, AvgTime1),
